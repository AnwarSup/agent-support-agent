# Agent Support Agent Architecture

## Overview

Agent Support Agent is packaged as a self-contained static web application. The page renders a product-grade AI-agent workflow without any server-side dependency.
