"""Crypto Support Agent multi-agent reasoning core.
...
PROJECT_NAME = 'Crypto Support Agent'
DOMAIN = 'customer support intelligence'
AUDIENCE = 'crypto customer success teams'
AGENT_ROLES = ['Ticket Classifier', 'Transaction Debugger', 'Policy-Aware Responder', 'Escalation Router', 'Knowledge Gap Miner']
SIGNALS = ['ticket_severity', 'tx_confirmation_age', 'refund_risk', 'user_sentiment', 'kb_gap_score']
SCENARIOS = ['bridge transfer stuck', 'wallet connection failure', 'failed swap complaint']
