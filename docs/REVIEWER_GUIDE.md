# Reviewer Guide — Support Agent Studio
...
## Product objective
Triage support tickets into response and KB updates.
...
print(run_pipeline_sync("Support Agent Studio", {"subject":"support_queue reviewer smoke"}))
PY
```
