# Product Spec — Crypto Support Agent

## Problem

Crypto customer success teams need fast, explainable decisions in customer support intelligence workflows. Static dashboards are not enough; the product must show how agents reason, verify, and produce action plans.
